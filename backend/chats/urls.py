...
urlpatterns = [
    ...
    path(
        "contact/<int:pk>/", views.chat_detail_by_contact, name="chat_detail_by_contact"
    ),
    path(
        "<int:pk>/set-last-read-message/",
        views.set_last_read_message,
        name="set_last_read_message",
    ),
